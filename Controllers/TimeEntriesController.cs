    ...
    public class TimeEntriesController : ControllerBase
    {
        ...
        public async Task<ActionResult<TimeEntry>> CreateTimeEntry([FromBody] CreateTimeEntryModel model)
        {
            ...
            var timeEntry = new TimeEntry
            {
                ...
                Date = model.Date,
                ClockIn = model.ClockIn.HasValue ? model.ClockIn.Value.TimeOfDay : null,
                ClockOut = model.ClockOut.HasValue ? model.ClockOut.Value.TimeOfDay : null,
        ...
        public async Task<IActionResult> UpdateTimeEntry(Guid id, [FromBody] UpdateTimeEntryModel model)
        {
            ...
            // Convert DateTime? to TimeSpan? if needed
            if (model.ClockIn.HasValue)
            {
                timeEntry.ClockIn = model.ClockIn.Value.TimeOfDay;
            }
            
            if (model.ClockOut.HasValue)
            {
                timeEntry.ClockOut = model.ClockOut.Value.TimeOfDay;
            }
